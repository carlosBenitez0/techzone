...
import { FaUser, FaEnvelope, FaMapPin, FaPhone, FaEdit, FaSave, FaArrowLeft, FaSignOutAlt } from 'react-icons/fa';
...
export const Profile: React.FC = () => {
    ...
    const [editData, setEditData] = useState<Omit<User, 'id' | 'roll' | 'password'>>({
    name: userData?.name || '',
    ...
    return (
      <div className={styles.loginPrompt}>
        <div className={styles.loginContent}>
          ...
          <p className={styles.loginText}>Debes iniciar sesión para ver tu perfil</p>
          <button
          ...
          <div className={styles.profileHeaderContent}>
            <div className={styles.profileHeaderInfo}>
              ...
              <div>
                ...
                <p className={styles.profileSubtitle}>Gestiona tu información personal</p>
              </div>
            </div>
        ...
        <div className={styles.statsGrid}>
          ...
          <div className={styles.statCard}>
            <div className={`${styles.statIconContainer} ${styles.bgGreen100}`}>
              <FaEnvelope className={`${styles.statIcon} ${styles.textGreen600}`} />
            </div>
          ...
          <div className={styles.statCard}>
            <div className={`${styles.statIconContainer} ${styles.bgPurple100}`}>
              <FaPhone className={`${styles.statIcon} ${styles.textPurple600}`} />
            </div>
            <h3 className={styles.statTitle}>Perfil Completo</h3>
            <p className={styles.statDescription}>
              {userData?.phone && userData?.address ? '100% completo' : 'Completa tu perfil'}
            </p>
          </div>
